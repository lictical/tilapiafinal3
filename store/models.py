...
#     name = AbstractUser.na

###============ this model handles the categories of the products ================
...
# ============== this model handles the data of the products
...
#=========== this models creates a zettel so that one can buy its products it is connected
# ========== with the Users model from django with a foreign key=================
